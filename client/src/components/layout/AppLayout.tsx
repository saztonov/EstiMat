...
export function AppLayout() {
  ...
  const menuItems = useMemo(() => {
    ...
    // Свои заявки (в т.ч. оформление РП) подрядчик ведёт на вкладке «Заявки» внутри сметы объекта;
    // отдельный пункт меню «Заявки» — только для внутренних ролей (пульт снабжения).
