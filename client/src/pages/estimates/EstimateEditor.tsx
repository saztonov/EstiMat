...
export function EstimateEditor({ estimate, orgs, onBack, refetchKey }: Props) {
  ...
  const groups = useMemo(
    () => buildCostTypeGroups(applyPendingOverlay(estimate.items), estimate.contractors, pendingGroups, estimate.cost_type_comment_counts, estimate.cost_type_ciphers),
