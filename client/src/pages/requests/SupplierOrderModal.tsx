...
import {
  Modal, Steps, Table, Button, Space, Input, InputNumber, Select, Radio, Tag, Empty, Divider,
...
import {
  ...
  FileExcelOutlined, MoreOutlined, PaperClipOutlined,
...
function CreateStep({
  ...
  return (
    <Modal
      open title="Заказ поставщику — состав" width={780}
