...
export const AI_PROMPT_DEFS: readonly AiPromptDef[] = [
  {
    ...
    description:
      'Основные правила разбора материалов на производственные операции и проверки комплектности. К нему автоматически добавляется блок правил границ по настройкам группировки.',
    group: 'grouping',
  },
  {
    id: 'grouping.merge',
    title: 'Промпт слияния групп',
    description: 'Второй проход: объединение черновых групп одной операции, разъехавшихся по наборам.',
    group: 'grouping',
  },
  {
    id: 'chat.system',
