...
export const aiJobStatusSchema = z.enum([
  ...
  'ready', // результат сформирован, ещё не применён (транзитный в авто-потоке)
...
/**
 * Откуда брать справочник при сопоставлении. COMPAT-ONLY: на ИИ больше не влияет
 * (чат и РД-извлечение зафиксированы на legacy). Оставлено для совместимости БД/API.
 */
