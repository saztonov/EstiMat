...
import { createTenderSchema } from '@estimat/shared'
...
export async function GET(request: NextRequest) {
  ...
  const material_group_id = searchParams.get('material_group_id')
  ...
  if (material_group_id) {
    query = query.eq('material_group_id', material_group_id)
  }
