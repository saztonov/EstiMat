...
import { createPurchaseRequestSchema } from '@estimat/shared'
...
export async function GET(
  ...
  let query = supabase
    ...
    .select(
      '*, contractor:organizations(id, name), estimate:estimates(id, work_type), creator:users!created_by(id, full_name)',
      { count: 'exact' }
    )
